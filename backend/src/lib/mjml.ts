    ...
    <mj-body background-color="#ffffff">
      <mj-section background-color="#ffffff">
        <mj-column>
          ...
          <mj-button css-class="verification-button" background-color="#0070f3" color="white" font-size="16px" font-weight="500" border-radius="6px" inner-padding="15px 25px" href="${link}">
            Verify My Email
          </mj-button>
